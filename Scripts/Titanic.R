####################################################################
## This script is used to prepare and anlyze the data for the 
## Tatanic exercise on kaggle.com.  The purpose is to use a training
## data set to predict the survival status of passengers in the test  
## set.
## The script was writtend during June 2014 and is based on the 
## tutorial at statsguys.wordpress.com
####################################################################
...
###################################################################
## Data conversion- the name field is reduced to the title (Mr. etc)
## for most items.  Non conforming items, such as Colonel, were left.
####################################################################
...
####################################################################
## The age variable is not complete for all items.  The folling 
## code is to estimate the age of that person based on the average
## age of all other items in the categories.
####################################################################
...
##################################################################
## To create a variable to identify the passenger as a child.  
## Child is defined as less that age 12.
####################################################################
trainData$Child
for (i in 1:nrow(trainData)){
...
####################################################################
## To create a variable to identify the passenger as a mother.  The
## assumption is that all passengers with the title "Mrs" and have
## a child value greater than 0.
####################################################################
trainData$Mother
for(i in 1:nrow(trainData)) {
