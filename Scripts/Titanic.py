...
path = "c:/users/ryan/dropbox/projects/titanic/data/titanic-train.csv"
...
submission.to_csv("c:/users/ryan/dropbox/projects/titanic/outputs/submission.csv", index = False)